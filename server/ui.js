var a11ypi = {
	...
	var overlay_template = '<div id="renarrated_overlay" class="alipi ui-widget-header ui-corner-all">'+
	    ...
	    '<input id="edit-current" class="alipi" type="submit" onclick="a11ypi.editPage();" value="Re-narrate this page">'+
            ...
            '<select id="blog-filter" class="alipi" onchange="a11ypi.checkSelect();"></select>'+
            '<input id="go" class="alipi" type="submit" onclick="a11ypi.go();" value="|Y|" title="Filter by specified blog">'+
	    ...
	    'class="alipi"></div><div id="share-box" class="alipi" title="Share this page in any following social network">'+
	    '<input id="info" class="alipi" type="submit" onclick="a11ypi.showInfo();"></input></div>';
