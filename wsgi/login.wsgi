...
def application(environ, start_response):
    ...
    blogEntry = CreatePublicPost(blogger_service, blog_id, title=parameter['title'], content=parameter['content']+'&amp;lang='+ parameter['lang'] +'">here</a></blockquote>')
    time.sleep(10)
    cmd = 'cd /home/alipi-crawler/a11ypi;scrapy crawl --spider a11y.in ' + blogEntry.GetHtmlLink().href
