...
//    textPopupDiv.appendChild(upArrow);
  ...
  //shalini-added cancelbutton
    var self = this, overlayDiv, firstRowDiv, firstRowStyleAttributes, messageDiv, publishButton, undoButton;
    ...
    var redButtonStyleAttributes, firstRowDivOffset, calculateScrollPositionY, wrapperDiv,showKeepOriginalOverlay, publishOptions = new PublishOptions();
    ...
    firstRowStyleAttributes = editAttributes.addStyle('color: #FFF;'
      ...
      + ' min-width: 800px; height: 56px; width: 100%; position: relative; left: 0;'
      + ' z-index: 2147483646; overflow-x: visible;'
...
// Ajay - Below message display bar
    messageDiv = DOM.BUILDER.DIV(editAttributes.addStyle('font-weight:normal; font-size:20px; font-family: Helvetica Neue, Helvetica, Arial, Sans-serif;position: relative; display: inline-block; vertical-align: top; padding-top: 15px; margin-left: 50px; color: #fff;').values());

// Ajay - background-color & rgba changed
    redButtonStyleAttributes = panelButtonAttributes.addStyle('width:30%; color:#FFF; float:right; height: 36px; font-weight:bold; font-size:18px; text-align:center; margin-top: 8px; margin-right: 30px; background: #AAA; background: -moz-linear-gradient(center bottom, #000 0%, #FFF 100%); border: 1px solid #777; border-radius: 3px; -moz-border-radius:10px; -webkit-border-radius:3px; border: 1px solid #777; box-shadow: #fff 0px 0px 2px 0px inset, rgba(0, 0, 0, .5) 0px 0px 2px 0px; -moz-box-shadow:#fff 0px 0px 2px 0px inset, rgba(0, 0, 0, .5) 0px 0px 2px 0px; -webkit-box-shadow:#fff 0px 0px 2px 0px inset, rgba(0, 0, 0, .5) 0px 0px 2px 0px;').values();
...
// Ajay - created
    ...
    locSelectAttributes = panelButtonAttributes.addStyle('width:23%; color:#FFF; float:left; height: 36px; font-weight:bold; font-size:18px; text-align:center; margin-top:8px; margin-left:-43%; background: #AAA; background: -moz-linear-gradient(center bottom, #000 0%, #FFF 100%); border: 1px solid #777; border-radius: 3px; -moz-border-radius:10px; -webkit-border-radius:3px; border: 1px solid #777; box-shadow: #fff 0px 0px 2px 0px inset, rgba(0, 0, 0, .5) 0px 0px 2px 0px; -moz-box-shadow:#fff 0px 0px 2px 0px inset, rgba(0, 0, 0, .5) 0px 0px 2px 0px; -webkit-box-shadow:#fff 0px 0px 2px 0px inset, rgba(0, 0, 0, .5) 0px 0px 2px 0px;').values();

    langSelectAttributes = panelButtonAttributes.addStyle('width:25%; color:#FFF; float:left; height: 36px; font-weight:bold; font-size:18px; text-align:center; margin-top:8px; margin-left:-70%; background: #AAA; background: -moz-linear-gradient(center bottom, #000 0%, #FFF 100%); border: 1px solid #777; border-radius: 3px; -moz-border-radius:10px; -webkit-border-radius:3px; border: 1px solid #777; box-shadow: #fff 0px 0px 2px 0px inset, rgba(0, 0, 0, .5) 0px 0px 2px 0px; -moz-box-shadow:#fff 0px 0px 2px 0px inset, rgba(0, 0, 0, .5) 0px 0px 2px 0px; -webkit-box-shadow:#fff 0px 0px 2px 0px inset, rgba(0, 0, 0, .5) 0px 0px 2px 0px;').values();

    styleSelectAttributes = panelButtonAttributes.addStyle('width:20%; color:#FFF; float:left; height: 36px; font-weight:bold; font-size:18px; text-align:center; margin-top:8px; margin-left:-92%; background: #AAA; background: -moz-linear-gradient(center bottom, #000 0%, #FFF 100%); border: 1px solid #777; border-radius: 3px; -moz-border-radius:10px; -webkit-border-radius:3px; border: 1px solid #777; box-shadow: #fff 0px 0px 2px 0px inset, rgba(0, 0, 0, .5) 0px 0px 2px 0px; -moz-box-shadow:#fff 0px 0px 2px 0px inset, rgba(0, 0, 0, .5) 0px 0px 2px 0px; -webkit-box-shadow:#fff 0px 0px 2px 0px inset, rgba(0, 0, 0, .5) 0px 0px 2px 0px;').values();

    authorInputAttributes = panelButtonAttributes.addStyle('width:28%; color:#FFF; float:left; height: 36px; font-weight:bold; font-size:18px; text-align:center; margin-top:8px; margin-left:-125%; background: #AAA; background: -moz-linear-gradient(center bottom, #000 0%, #FFF 100%); border: 1px solid #777; border-radius: 3px; -moz-border-radius:10px; -webkit-border-radius:3px; border: 1px solid #777; box-shadow: #fff 0px 0px 2px 0px inset, rgba(0, 0, 0, .5) 0px 0px 2px 0px; -moz-box-shadow:#fff 0px 0px 2px 0px inset, rgba(0, 0, 0, .5) 0px 0px 2px 0px; -webkit-box-shadow:#fff 0px 0px 2px 0px inset, rgba(0, 0, 0, .5) 0px 0px 2px 0px;').values();
...
//shalini
  /*  cancelButtonStyleAttributes = panelButtonAttributes.addStyle('width:15%; color:#FFF; float:left; height: 36px; font-weight:bold; font-size:18px; text-align:center; margin-top: 8px; margin-left:-130%; background: #AAA; background: -moz-linear-gradient(center bottom, #000 0%, #FFF 100%); border: 1px solid #777; border-radius: 3px; -moz-border-radius:10px; -webkit-border-radius:3px; border: 1px solid #777; box-shadow: #fff 0px 0px 2px 0px inset, rgba(0, 0, 0, .5) 0px 0px 2px 0px; -moz-box-shadow:#fff 0px 0px 2px 0px inset, rgba(0, 0, 0, .5) 0px 0px 2px 0px; -webkit-box-shadow:#fff 0px 0px 2px 0px inset, rgba(0, 0, 0, .5) 0px 0px 2px 0px;').values();*/
    ...
    publishButton = DOM.BUILDER.BUTTON(redButtonStyleAttributes, 'Save & Publish'); // Ajay - Done to Save Yass
    //pageEditor.saveAndClose();
    ...
    xhrloc.open("POST","http://x.a11y.in/alipi/getData",true);
    xhrloc.setRequestHeader("Content-type","application/x-www-form-urlencoded");
    xhrloc.send("data.json");//
    //////////////////////////////////////////////////////////////////////////////langs
    ...
    xhrlang.onreadystatechange = function()
     ...
     xhrlang.open("POST","http://x.a11y.in/alipi/getData",true);
     xhrlang.setRequestHeader("Content-type","application/x-www-form-urlencoded");
     xhrlang.send("toto");//// this is ignored on the server side; for now it just dumps data.json
  ...
  var xhr = new XMLHttpRequest();
    ...
    xhr.open("POST","http://x.a11y.in/alipi/getData",true);
...
// Ajay - Changed background color, made it transparent :)
    wrapperDiv =  DOM.BUILDER.DIV(fontTypeAttributes.addStyle('overflow: inherit; overflow-x: visible; position: fixed; z-index: 2147483645; left: 0; bottom: 0;min-width:800px; width: 100%; background-color: rgba(0, 0, 0, 0.5);').values(),
      //logoAnchor, //Ajay
      //secondRowDiv, //Ajay
	firstRowDiv);
...
// Ajay - publish
	...
	buffer = new UTIL.StringBuffer();
      ...
      UTIL.forEach(history, function(index, command) {
	      ...
	      buffer.append(encodeURIComponent(command.url));
